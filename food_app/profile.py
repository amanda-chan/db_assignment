...
def reviews():
    # add login required ^
    r_list = []
    return render_template("profile/reviews.html", user=current_user, reviews=r_list)
...
def bookings():
    # add login required ^
    b_list = []
    return render_template("profile/bookings.html", user=current_user, bookings=b_list)
...
def orders():
    # add login required ^
    o_list = []
    return render_template("profile/orders.html", user=current_user, orders=o_list)
